...
WIP: added Unicode/LongFilename-aware C++ services file_exists, dir_exists, search_config_file, read_binary_file, read_text_file and boost::optional<T> support
...
The `command` is a pseudo-table that includes the following fields:
